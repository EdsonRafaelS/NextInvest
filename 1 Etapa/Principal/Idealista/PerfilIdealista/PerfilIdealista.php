...
if (!isset($_SESSION['idealizador_logado_id'])) {
    ...
    header('Location:http://localhost/nextinvest/1%20Etapa/Login/LoginIdealista.html');
    exit();
}
...
$query = "SELECT ID, Nome, IFNULL(Telefone, '00 000000000') AS Telefone, Email FROM idealizadores WHERE ID = $id_usuario";
...
<body>
  ...
  <div class="idealista">
    <div class="container">
      <h1 class="display-4">Perfil Idealista!</h1>
    </div>
  </div>
